...
class CouponCell extends StatefulWidget {
  ...
  final String _benefitText;
  final String _codeText;

  const CouponCell(this._iconText, this._imageText, this._nameText,
      this._descText, this._addressText, this._benefitText, this._codeText);
  @override
